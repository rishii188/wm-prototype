...
CONFIG_PATH = ROOT / "configs" / "core_main_matrix.json"
OUT_PATH = ROOT / "data" / "full_run_core_matrix_results.jsonl"
...
print(f"Running core matrix from config: {CONFIG_PATH}")
